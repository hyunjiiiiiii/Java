...
public class IntList {
    ...
    public int get(int position) {
        ...
        throw new IllegalArgumentException("position not existing");
    }
    ...
    public String toString() {
        //TODO: YOUR CODE HERE
        IntList list = this;
        String str = new String(Integer.toString(list.item));
        list = list.next;
        while(list != null) {
            str += " " + Integer.toString(list.item);
            list = list.next;
        }
        return str;
    }
    ...
    public boolean equals(Object obj) {
        ...
        //TODO: YOUR CODE HERE
            ...
            while (otherLst != null && thisLst != null) {
                if (otherLst.item != thisLst.item) {
                    return false;
                }
                otherLst = otherLst.next;
                thisLst = thisLst.next;
            }
            if (otherLst != null || thisLst != null) {
                return false;
            }
            return true;
        }
    ...
    public int squaredSum() {
        ...
        while (list != null) {
            int squared = list.item * list.item;
            squaredSum += squared;
            list = list.next;
        }
        return squaredSum;
     ...
     */
     public static IntList catenate(IntList A, IntList B) {
        //TODO: YOUR CODE HERE
         ...
         IntList newlist = new IntList(A.item, catenate(A.next, new IntList(B.item, B.next)));
        return newlist;
     }
}